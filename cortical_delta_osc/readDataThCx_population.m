...
dt = .25;
%xRange = [15800 39500]+dt;
%xRange = [26200 28000]+dt;
xRange = [0 50000]+dt;
iRange = xRange./dt;
...
for data = data
    ...
    elseif data == 2
        ...
        populationPlot('Cortical layer 2/3 IN population data', '02i', cmLimCx, t, xLims, xTicks, vCx23i, Cx23iraster, 'grey', width, ratio2, label, margin, disp(2), data)
        populationPlot('Cortical layer 2/3 IN population data', '02i', cmLimCx, t, xLims, xTicks, vCx23i, Cx23iraster, 'hot', width, ratio2, label, margin, disp(3), data)
        populationPlot('Cortical layer 2/3 IN population data', '02i', cmLimCx, t, xLims, xTicks, vCx23i, Cx23iraster, 'cold', width, ratio2, label, margin, disp(4), data)
    elseif data == 3
    ...
    elseif data == 4
        ...
        populationPlot('Cortical layer 4 IN population data', '04i', cmLimCx, t, xLims, xTicks, vCx4i, Cx4iraster, 'grey', width, ratio2, label, margin, disp(2), data)
        populationPlot('Cortical layer 4 IN population data', '04i', cmLimCx, t, xLims, xTicks, vCx4i, Cx4iraster, 'hot', width, ratio2, label, margin, disp(3), data)
        populationPlot('Cortical layer 4 IN population data', '04i', cmLimCx, t, xLims, xTicks, vCx4i, Cx4iraster, 'cold', width, ratio2, label, margin, disp(4), data)
    elseif data == 5
...
%         hold off
    ...
    elseif data == 6
        ...
        populationPlot('Cortical layer 5 IN population data', '05i', cmLimCx, t, xLims, xTicks, vCx5i, Cx5iraster, 'grey', width, ratio2, label, margin, disp(2), data)
        populationPlot('Cortical layer 5 IN population data', '05i', cmLimCx, t, xLims, xTicks, vCx5i, Cx5iraster, 'hot', width, ratio2, label, margin, disp(3), data)
        populationPlot('Cortical layer 5 IN population data', '05i', cmLimCx, t, xLims, xTicks, vCx5i, Cx5iraster, 'cold', width, ratio2, label, margin, disp(4), data)
    elseif data == 7
    ...
    elseif data == 8
        ...
        populationPlot('Cortical layer 6 IN population data', '06i', cmLimCx, t, xLims, xTicks, vCx6i, Cx6iraster, 'grey', width, ratio2, label, margin, disp(2), data)
        populationPlot('Cortical layer 6 IN population data', '06i', cmLimCx, t, xLims, xTicks, vCx6i, Cx6iraster, 'hot', width, ratio2, label, margin, disp(3), data)
        populationPlot('Cortical layer 6 IN population data', '06i', cmLimCx, t, xLims, xTicks, vCx6i, Cx6iraster, 'cold', width, ratio2, label, margin, disp(4), data)
    elseif data == 9
        rPlot('Thalamic NRT FO population rastergram', '07_NRT_FO', t, xLims, xTicks, NRTraster, width, ratio2, label, margin, disp(1), data)
        populationPlot('Thalamic NRT FO population data', '07_NRT_FO', cmLimTh, t, xLims, xTicks, vNRT, NRTraster, 'grey', width, ratio2, label, margin, disp(2), data)
        populationPlot('Thalamic NRT FO population data', '07_NRT_FO', cmLimTh, t, xLims, xTicks, vNRT, NRTraster, 'hot', width, ratio2, label, margin, disp(3), data)
        populationPlot('Thalamic NRT FO population data', '07_NRT_FO', cmLimTh, t, xLims, xTicks, vNRT, NRTraster, 'cold', width, ratio2, label, margin, disp(4), data)
    elseif data == 10
        rPlot('Thalamic NRT HO population rastergram', '08_NRT_HO', t, xLims, xTicks, NRT2raster, width, ratio2, label, margin, disp(1), data)
        populationPlot('Thalamic NRT HO population data', '08_NRT_HO', cmLimTh, t, xLims, xTicks, vNRT2, NRT2raster, 'grey', width, ratio2, label, margin, disp(2), data)
        populationPlot('Thalamic NRT HO population data', '08_NRT_HO', cmLimTh, t, xLims, xTicks, vNRT2, NRT2raster, 'hot', width, ratio2, label, margin, disp(3), data)
        populationPlot('Thalamic NRT HO population data', '08_NRT_HO', cmLimTh, t, xLims, xTicks, vNRT2, NRT2raster, 'cold', width, ratio2, label, margin, disp(4), data)
    elseif data == 11
        rPlot('Thalamic TC FO population rastergram', '09_TC_FO', t, xLims, xTicks, TCraster, width, ratio, label, margin, disp(1), data)
        populationPlot('Thalamic TC FO population data', '09_TC_FO', cmLimTh, t, xLims, xTicks, vTC, TCraster, 'grey', width, ratio, label, margin, disp(2), data)
        populationPlot('Thalamic TC FO population data', '09_TC_FO', cmLimTh, t, xLims, xTicks, vTC, TCraster, 'hot', width, ratio, label, margin, disp(3), data)
        populationPlot('Thalamic TC FO population data', '09_TC_FO', cmLimTh, t, xLims, xTicks, vTC, TCraster, 'cold', width, ratio, label, margin, disp(4), data)
    elseif data == 12
        rPlot('Thalamic TC HO population rastergram', '10_TC_HO', t, xLims, xTicks, TC2raster, width, ratio, label, margin, disp(1), data)
        populationPlot('Thalamic TC HO population data', '10_TC_HO', cmLimTh, t, xLims, xTicks, vTC2, TC2raster, 'grey', width, ratio, label, margin, disp(2), data)
        populationPlot('Thalamic TC HO population data', '10_TC_HO', cmLimTh, t, xLims, xTicks, vTC2, TC2raster, 'hot', width, ratio, label, margin, disp(3), data)
        populationPlot('Thalamic TC HO population data', '10_TC_HO', cmLimTh, t, xLims, xTicks, vTC2, TC2raster, 'cold', width, ratio, label, margin, disp(4), data)
    end
end
...
%     end
    ...
    exportFig(gcf, [nameShort '_' type '.tif'],'-dtiffnocompression','-r300', paperSize);
    close(f)
end
...
%     end
    ...
    hold off
    exportFig(gcf, [nameShort '_rastergram.tif'],'-dtiffnocompression','-r300', paperSize);
    close(f)
end
